...
#       --patience 10 \
#       --gamma 0.7\
#       --itr 1 --batch_size 32 --learning_rate 1.5e-3 >logs/LongForecasting02/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log 
# done

# for pred_len in 336 # 336 often explodes
# do
#     python -u run_longExp.py \
#       --random_seed $random_seed \
#       --is_training 1 \
